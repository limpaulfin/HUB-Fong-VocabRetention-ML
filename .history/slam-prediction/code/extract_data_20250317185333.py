...
def main():
    ...
    data_dir = os.path.abspath(os.path.join(current_dir, "..", "data", "dataverse_files"))
    ...
    extract_dir = os.path.abspath(os.path.join(current_dir, "..", "data", "extracted_data"))

    print(f"Thư mục đích: {extract_dir}")
